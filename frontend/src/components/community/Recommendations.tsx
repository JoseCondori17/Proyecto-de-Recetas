...
const Recommendations = () => {
  return (
    <div className="bg-white rounded-lg p-4 shadow-md">
      ...
      <Link href="/home/recipes/category/healthy" passHref>
      ...
      <Link href="/home/recipes/category/breakfast" passHref>
